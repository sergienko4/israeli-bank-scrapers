...
- Post-auth uses the **hard-model** path (`withBrowserApiDirect`): after login the FIBI Mataf/appsng API is called directly (no DASHBOARD navigation or generic discovery). See [api-direct-scrape](../phases/api-direct-scrape.md).
