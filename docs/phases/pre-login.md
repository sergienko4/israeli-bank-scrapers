...
| **Source** | [`PreLoginPhase.ts`](https://github.com/sergienko4/israeli-bank-scrapers/blob/main/src/Scrapers/Pipeline/Phases/PreLogin/PreLoginPhase.ts) + [`PreLoginActions.ts`](https://github.com/sergienko4/israeli-bank-scrapers/blob/main/src/Scrapers/Pipeline/Mediator/PreLogin/PreLoginActions.ts) |
