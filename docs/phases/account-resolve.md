...
| **Source** | [`AccountResolvePhase.ts`](https://github.com/sergienko4/israeli-bank-scrapers/blob/main/src/Scrapers/Pipeline/Phases/AccountResolve/AccountResolvePhase.ts) + [`AccountResolveActions.ts`](https://github.com/sergienko4/israeli-bank-scrapers/blob/main/src/Scrapers/Pipeline/Mediator/AccountResolve/AccountResolveActions.ts) |
