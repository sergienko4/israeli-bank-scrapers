...
| **Source** | [`AuthDiscoveryPhase.ts`](https://github.com/sergienko4/israeli-bank-scrapers/blob/{{BRANCH}}/src/Scrapers/Pipeline/Phases/AuthDiscovery/AuthDiscoveryPhase.ts) + [`AuthDiscovery/`](https://github.com/sergienko4/israeli-bank-scrapers/blob/{{BRANCH}}/src/Scrapers/Pipeline/Mediator/Network/AuthDiscovery/index.ts) |
