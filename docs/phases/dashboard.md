...
| **Source** | [`DashboardPhase.ts`](https://github.com/sergienko4/israeli-bank-scrapers/blob/main/src/Scrapers/Pipeline/Phases/Dashboard/DashboardPhase.ts) + [`DashboardPhaseActions.ts`](https://github.com/sergienko4/israeli-bank-scrapers/blob/main/src/Scrapers/Pipeline/Mediator/Dashboard/DashboardPhaseActions.ts) |
