...
// facade. Phase 12e drained the 167-LoC ScrapeExecutor god-module
// into co-located <=150-LoC Types/Fetch/Account/Execute modules
// behind a barrel facade. This canary + the eslint.config.mjs
// override block guarantee no future commit can re-blob the generic
// scrape executor. Sits one line above the 150-effective-line ceiling so
// "npm run lint:canaries" confirms max-lines fires — its body must
// stay exactly 151 non-blank, non-comment lines.
