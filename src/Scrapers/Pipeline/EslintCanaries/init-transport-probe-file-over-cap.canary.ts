...
// NavigationTransportProbe facade. Phase 12e drained the 1036-LoC
// NavigationTransportProbe god-module into co-located <=150-LoC
// Url/Dns/Tcp/Tls/Result/Probe modules behind a barrel facade. This
// canary + the eslint.config.mjs override block guarantee no future
// commit can re-blob the transport probe. Pads above the
// 150-effective-line ceiling so "npm run lint:canaries" confirms
// max-lines fires — its body must stay exactly 151 non-blank, non-comment
// lines.
