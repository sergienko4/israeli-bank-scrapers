...
// re-blob ScrapeAutoMapper.ts (or any of its eleven successors)
// back toward four-digit line counts. The body below is padded
// above the 150 effective-line ceiling so verify.sh confirms
// the rule fires.
