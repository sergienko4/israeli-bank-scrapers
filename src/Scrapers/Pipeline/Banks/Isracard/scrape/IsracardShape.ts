 ...
 * against the Isracard DigitalV3 API (base-isracard-amex backbone, host
 * web.isracard.co.il). Helpers split across IsracardShapeHelpers.ts,
 * IsracardShapeTxns.ts and IsracardShapeExtract.ts to hold the file-size cap.
 */
