/**
 * Otsar Hahayal (FIBI group) scrape shape — the transactions URL bound to the
 * Otsar Hahayal origin. The request envelope and page extractor are
...
export function txnsUrl(): WKUrlOrLiteral {
  return fibiTxnsUrl(OTSAR_HAHAYAL_CONFIG);
}
