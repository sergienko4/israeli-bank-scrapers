/**
 * TERMINATE-phase timing budgets. Split out of the TimingConfig barrel during
 ...
 * Phase 12b split keeps every domain in its own file so every domain owns its own
 * file. The `import-x/prefer-default-export`
