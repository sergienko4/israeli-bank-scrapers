...
export const NO_TRANSACTION_IN_DATE_RANGE_TEXT = 'לא נמצאו נתונים בנושא המבוקש';
export const DATE_COLUMN_CLASS_COMPLETED = 'date first';
export const DATE_COLUMN_CLASS_PENDING = 'first date';
export const DESCRIPTION_COLUMN_CLASS_COMPLETED = 'reference wrap_normal';
export const DESCRIPTION_COLUMN_CLASS_PENDING = 'details wrap_normal';
export const REFERENCE_COLUMN_CLASS = 'details';
export const DEBIT_COLUMN_CLASS = 'debit';
export const CREDIT_COLUMN_CLASS = 'credit';
