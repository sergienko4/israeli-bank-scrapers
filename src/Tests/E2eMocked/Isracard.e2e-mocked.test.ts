 ...
 * Tests time out at 60s during the mocked scrape lifecycle. Likely the
 * same fixture-route-mismatch issue as Discount/VisaCal/Max but here the
 * test uses amexRoutes() shared mock which needs reauthoring. Out of scope.
 */
describe.skip('Isracard: Mocked E2E', () => {
