 ...
 * The auto-generated fixtures.json (from `npm run capture:invalid-login -- discount`)
 * is a scaffold whose URL globs do NOT match Discount's real URL topology
 * (login page on start.telebank.co.il, API on /Lobby/gatewayAPI/...). The
 * scraper hangs on unmocked routes and times out at 90 s. Re-enable once
 * the fixtures.json route table has been authored manually for Discount.
 */
describe.skip('offline Discount invalid-creds', () => {
