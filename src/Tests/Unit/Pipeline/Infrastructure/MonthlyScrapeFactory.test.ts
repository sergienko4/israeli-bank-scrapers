...
import type { IMonthlyConfig } from '../../../../Scrapers/Pipeline/Strategy/Scrape/Monthly/MonthlyScrapeFactory.js';
import { createMonthlyScrapeFn } from '../../../../Scrapers/Pipeline/Strategy/Scrape/Monthly/MonthlyScrapeFactory.js';
...
describe('createMonthlyScrapeFn', () => {
  ...
  it('keeps separate accounts with different accountNumbers', async () => {
    const config: IMonthlyConfig = {
       ...
       */
      getMonthTransactions: () => {
        const acct1 = makeAccount('4718', 1);
        const acct2 = makeAccount('6281', 2);
