...
import { createPostLoginStep } from '../../../../Scrapers/Pipeline/Mediator/Login/LoginSteps.js';
...
function makeMockMediator(): IElementMediator {
  const mediator: IElementMediator = {
    ...
    /**
     * Scoped resolve mock — returns NOT_FOUND.
     * @returns NOT_FOUND result.
     */
    resolveVisibleInContext: () => Promise.resolve(NOT_FOUND_RESULT),
    /**
