    ...
    const scraper = new ConcreteGenericScraper(
      {
        ...
        preparePage: async page => {
          await setupRequestInterception(page, [
            { match: 'test-bank.local/login', contentType: 'text/html; charset=utf-8', body: OTP_CODE_ENTRY_HTML },
            { match: 'test-bank.local/dashboard', contentType: 'text/html; charset=utf-8', body: DASHBOARD_HTML },
          ]);
        },
    ...
    const scraper = new ConcreteGenericScraper(
      {
        ...
        preparePage: async page => {
          await setupRequestInterception(page, [
            { match: 'test-bank.local/login', contentType: 'text/html; charset=utf-8', body: OTP_SELECTION_HTML },
            { match: 'test-bank.local/dashboard', contentType: 'text/html; charset=utf-8', body: DASHBOARD_HTML },
          ]);
        },
        otpCodeRetriever: retrieverSpy,
    ...
    const scraper = new ConcreteGenericScraper(
      {
        ...
        preparePage: async page => {
          await setupRequestInterception(page, [
            { match: 'test-bank.local/login', contentType: 'text/html; charset=utf-8', body: NORMAL_LOGIN_HTML },
            { match: 'test-bank.local/dashboard', contentType: 'text/html; charset=utf-8', body: DASHBOARD_HTML },
          ]);
        },
      },
    ...
    const scraper = new ConcreteGenericScraper(
      {
        ...
        preparePage: async page => {
          await setupRequestInterception(page, [
            { match: 'test-bank.local/login', contentType: 'text/html; charset=utf-8', body: LOGIN_ERROR_HTML },
            { match: 'test-bank.local/error', contentType: 'text/html; charset=utf-8', body: ERROR_PAGE_HTML },
          ]);
        },
        otpCodeRetriever: retrieverSpy,
      },
