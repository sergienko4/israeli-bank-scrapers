...
export const accountDropDownItemSelector = '#AccountPicker .item';
export const pendingTrxIdentifierId = '#ctl00_ContentPlaceHolder2_panel1';
export const genericDescriptions = ['העברת יומן לבנק זר מסניף זר'];
...
export function createDataFromRequest(request: Request, optionsStartDate: Date): MizrahiRequestData {
